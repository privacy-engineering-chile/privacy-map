...
export const dict: Dict = {
  ...
  "ch1.lead":                { es: "Dónde existe ley integral, sectorial o ninguna.", en: "Where comprehensive, sectoral, or no law exists." },
  "ch1.sids":                { es: "{n} pequeños estados insulares aún sin ley integral.", en: "{n} small island states still without a comprehensive law." },

  "ch2.title":               { es: "La red de tratados",                              en: "The treaty network" },
  "ch2.lead":                { es: "Conexiones invisibles que tejen el estándar global.", en: "Invisible connections weaving the global standard." },

  "ch3.title":               { es: "Evolución y madurez",                             en: "Evolution & maturity" },
  "ch3.lead":                { es: "Quién modernizó su marco y quién se quedó atrás.", en: "Who modernised their framework, and who fell behind." },
  ...
  "de.lead":                 { es: "Cobertura por clasificación · global: {pct}% con ley integral.", en: "Coverage by classification · global: {pct}% with comprehensive law." },
  ...
  "sk.lead":                 { es: "Cada hilo = jurisdicciones de una región en un tratado.", en: "Each thread = jurisdictions of a region within a treaty." },

  // TravelRiskTool
  "trv.title":               { es: "¿Tus datos viajan seguros?",                      en: "Do your data travel safely?" },
  "trv.lead":                { es: "Compara países y mide la caída en protección al cruzar la frontera.", en: "Compare countries and measure the protection drop across borders." },
  ...
  "cc.lead":                 { es: "Leyes, autoridad, tratados y antigüedad — lado a lado.", en: "Laws, authority, treaties and age — side by side." },
  ...
  "dr.rank.text":            { es: "País #{n} en adoptar regulación integral.",       en: "Country #{n} to adopt comprehensive regulation." },
